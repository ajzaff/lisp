...
func TestTokenizeLit(t *testing.T) {
	for _, tc := range []scanTestCase{{
		...
		wantNodes: []Node{
			...
			&LitNode{LitPos: 2, Lit: IntLit(0), EndPos: 3},
		},
	}, {
		name:     "id symbol",
		input:    "a...",
		...
		wantTok:   []Token{Int},
		wantText:  []string{"0"},
		wantNodes: []Node{&LitNode{LitPos: 0, Lit: IntLit(0), EndPos: 1}},
	}, {
		name:     "int 2",
		input:    "0 1 2",
		wantPos:  []Pos{0, 1, 2, 3, 4, 5},
		...
		wantNodes: []Node{
			&LitNode{LitPos: 0, Lit: IntLit(0), EndPos: 1},
			&LitNode{LitPos: 2, Lit: IntLit(1), EndPos: 3},
			&LitNode{LitPos: 4, Lit: IntLit(2), EndPos: 5},
		},
	}, {
		name:      "float",
		input:     "1.0",
		...
		wantTok:   []Token{Float},
		wantText:  []string{"1.0"},
		wantNodes: []Node{&LitNode{LitPos: 0, Lit: FloatLit(1.0), EndPos: 3}},
	}, {
		name:      "float 2",
		input:     "1.",
		wantPos:   []Pos{0, 2},
		wantTok:   []Token{Float},
		wantText:  []string{"1."},
		wantNodes: []Node{&LitNode{LitPos: 0, Lit: FloatLit(1.0), EndPos: 2}},
	}, {
		name:      "float 3",
		input:     "0.",
		wantPos:   []Pos{0, 2},
		wantTok:   []Token{Float},
		wantText:  []string{"0."},
		wantNodes: []Node{&LitNode{LitPos: 0, Lit: FloatLit(0), EndPos: 2}},
	}, {
		name:     "float 4",
		input:    "1. 2. 3.",
		wantPos:  []Pos{0, 2, 3, 5, 6, 8},
		...
		wantNodes: []Node{
			&LitNode{LitPos: 0, Lit: FloatLit(1), EndPos: 2},
			&LitNode{LitPos: 3, Lit: FloatLit(2), EndPos: 5},
			&LitNode{LitPos: 6, Lit: FloatLit(3), EndPos: 8},
		},
	}, {
		name:     "float 4_2",
		input:    "0.1 0.2 0.3",
		...
		wantNodes: []Node{
			&LitNode{LitPos: 0, Lit: FloatLit(.1), EndPos: 3},
			&LitNode{LitPos: 4, Lit: FloatLit(.2), EndPos: 7},
			&LitNode{LitPos: 8, Lit: FloatLit(.3), EndPos: 11},
		},
	}, {
		name:      "string",
		input:     `"a"`,
...
func TestTokenizeExpr(t *testing.T) {
	for _, tc := range []scanTestCase{{
		...
		wantNodes: []Node{&ExprNode{LParen: 0, Expr: Expr{
			...
			&LitNode{LitPos: 5, Lit: IntLit(1), EndPos: 6},
			&LitNode{LitPos: 7, Lit: IntLit(2), EndPos: 8},
		}, RParen: 8}},
	}, {
		name:     "expr 3",
		input:    "(add (sub 3 2) 2)",
		...
		wantNodes: []Node{&ExprNode{LParen: 0, Expr: Expr{
			...
			&ExprNode{LParen: 5, Expr: Expr{
				...
				&LitNode{LitPos: 10, Lit: IntLit(3), EndPos: 11},
				&LitNode{LitPos: 12, Lit: IntLit(2), EndPos: 13},
			}, RParen: 13},
			&LitNode{LitPos: 15, Lit: IntLit(2), EndPos: 16},
		}, RParen: 16}},
	}, {
		name:     "expr 4",
		input:    "((a))",
